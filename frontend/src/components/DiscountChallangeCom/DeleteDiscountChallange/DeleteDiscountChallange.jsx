...
const DeleteDiscountChallange = ({ handleDeleteClose, showDelete ,handleDelete}) => {
    ...
    <div>   
      <Modal show={showDelete} onHide={handleDeleteClose}>
        <Modal.Header>
          ...
          <Modal.Body>
            <p>Are you sure you want to delete this challange?</p>
          </Modal.Body>
          <Modal.Footer>
...
export default DeleteDiscountChallange;
